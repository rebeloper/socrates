...
- [Introduction: AI Isn't Replacing Developers](#introduction-ai-isnt-replacing-developers) — The real question isn't whether AI replaces developers, it's whether it quietly changes how they learn.
- [Productivity Is Becoming a Commodity](#productivity-is-becoming-a-commodity) — As AI closes the productivity gap between developers, judgment becomes the new differentiator.
- [The Silent Trade](#the-silent-trade) — Every shortcut removes some friction, and friction is often where learning happens.
- [Passive Development](#passive-development) — Shipping more with AI doesn't automatically mean growing; growth now has to be chosen on purpose.
- [Syntax Is Cheap, Complexity Isn't](#syntax-is-cheap-complexity-isnt) — The bottleneck has moved from writing correct code to judging what should be built.
- [Capability Compounds](#capability-compounds) — Like money, skill only compounds when the lessons behind it are kept, not just encountered.
- [Pause](#pause) — Every use of AI is two investments at once: one in the output, one in the person producing it.
- [The Solution](#the-solution) — Concrete habits — predict, question, ask to be taught, keep the lesson — for turning philosophy into daily practice.
- [The Long Game](#the-long-game) — Careers compound over decades, not sprints; the durable edge is who you become, not which tool you master.
- [Invest in Yourself](#invest-in-yourself) — A closing call to use AI to move faster while treating your own growth as the real asset.
